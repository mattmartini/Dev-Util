...
The sub-modules provide the functionality described below.  For more details see C<<< perldoc <Sub-module_Name> >>>.


=head2 Dev::Util

C<Dev::Util> provides a loader for sub-modules where a leading C<::> denotes a package to load.
